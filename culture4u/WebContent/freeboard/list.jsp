...
<table class="highlight" >
	<tr>
		<th class="center">글번호</th><th>작성자</th><th class="center">글제목</th><th>조회수</th><th class="center">날짜</th><th class="center">IP</th>
	</tr>
	...
	<c:if test="${list.size() != 0 }">
		...
		<tr>
			...
			<td>${dto.fHit }</td>
			<td class="center"><fmt:formatDate value="${dto.fRdate }" pattern="yy년MM월dd일(E)" /> </td>
			<td class="center">${dto.fIp }</td>
		</tr>		
		</c:forEach>
	</c:if>
</table>
